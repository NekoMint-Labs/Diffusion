"""Direct provider execution and deterministic retrieval fusion."""
...
async def search(
    ...
    *,
    ...
    return RetrievalOutcome(tuple(ranked[: policy.max_results]), tuple(attempts), tuple(p.provider_id for p in providers))
