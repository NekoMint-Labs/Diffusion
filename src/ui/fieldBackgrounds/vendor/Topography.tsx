/**
 * Adapted from React Bits Topography at commit 9481af758aae6cfb34c3652ec40a1c099360331f.
 * MIT + Commons Clause; see docs/third_party/REACT_BITS_MATERIALS_LICENSE.md.
 * Diffusion changes: static motion mode, CSS-pixel resolution cap, pointer-inert use, and shared viewport styling.
 */
...
const Topography: React.FC<TopographyProps> = ({
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      renderer.render({ scene: mesh });
      raf = (u.uSpeed.value as number) > 0 ? requestAnimationFrame(loop) : 0;
    };
